...
library('devtools')
library('remotes')
devtools::install_version('clam', version='2.3.9', repos= "https://cloud.r-project.org")
devtools::install_version('rbacon', version='2.5.2', repos= "https://cloud.r-project.org")
